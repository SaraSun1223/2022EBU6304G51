...
public class ManagementFrame extends MouseAdapter implements ActionListener{
    ...
    JPanel j3p1;
    JPanel j3p2;
    String[] Names3 = {"ID number","Meal name","Brand","Inventory","Being supplied"};
    String[][] Info3 ={
            {"60881111","Chicken noodle","London Heathrow Airpport","433","True"},
            {"60881112","Green salad","London Heathrow Airpport","345","True"}
    };
    JPanel j4p1;
    JPanel j4p2;
...
//      psg
        ...
        JScrollPane s4 = new JScrollPane(MealInftable);
